    ...
    <div class="row">
      <div class="col-12">
        <form method="GET" action="" class="row g-2 align-items-end mb-3">
          ...
          <div class="col-12 col-md-3">
            <label for="search" class="form-label">Nama</label>
          ...
          <div class="col-auto">
            <div class="btn-group">
              ...
              <a href="{{route('karyawan.list')}}" class="btn btn-danger">
              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> <p class="my-0 text-muted">{{$user->karyawan->nik_user}}</p>
                    </td>
                    <td>
                      {{ $user->karyawan->unit->nama_unit }}
                    </td>
                    <td>
