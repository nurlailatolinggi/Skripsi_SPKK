            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input type="text" name="nik_user" id="nik_user" class="form-control" value="{{old('nik_user')}}">
                  @error('nik_user')
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input type="text" name="nama_user" id="nama_user" class="form-control" value="{{old('nama_user')}}">
                  @error('nama_user')
                    <small class="text-danger">{{$message}}</small>
                  @enderror
                </div>
