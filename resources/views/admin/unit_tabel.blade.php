  ...
  <div class="page-inner">
    ...
    >
      ...
      <div class="ms-md-auto py-2 py-md-0">
        <a href="{{route('unit.create')}}" class="btn btn-primary btn-round">Tambah Unit</a>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
        <div class="card card-round">
          ...
          <div class="card-header">
            <div class="card-head-row">
              <div class="card-title">Tabel Unit</div>
              <div class="card-tools">
                <div class="input-group">
                  ...
                  <div class="input-group-apend">
                    ...
                    <a href="{{route('unit.list')}}" class="btn btn-danger">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form action="{{ route('unit.destroy', $unit->id) }}" method="POST" style="display:inline" class="form-hapus">
                          @csrf
                          @method('DELETE')
