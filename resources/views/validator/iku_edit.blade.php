            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <textarea name="deskripsi_indikator" id="deskripsi_indikator" class="form-control">{{$iku->deskripsi_indikator}}</textarea>
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input type="text" name="indikator_keberhasilan" id="indikator_keberhasilan" class="form-control" value="{{$iku->indikator_keberhasilan}}">
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input type="text" name="parameter" id="parameter" class="form-control" value="{{$iku->parameter}}">
                  @error('parameter')
                    <small class="text-danger">{{$message}}</small>
                  @enderror
                </div>
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <select name="frekuensi_indikator" id="frekuensi_indikator" class="form-control">
                    ...
                    <option value="BULANAN" {{$iku->frekuensi_indikator == 'BULANAN' ?'selected':''}}>BULANAN</option>
                    <option value="TAHUNAN" {{$iku->frekuensi_indikator == 'TAHUNAN' ?'selected':''}}>TAHUNAN</option>
                  </select>
